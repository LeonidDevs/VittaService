...
public partial class VittaDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:VittaDB");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BCF2BF68133");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__57ED0681175799C0");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD72C05F68");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C296222CF");
